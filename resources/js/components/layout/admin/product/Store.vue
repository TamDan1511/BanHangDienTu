            ...
            <div class="mt-5 row" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9" style="min-height: 200px">
                                <div class="border bg-white h-100">
                                    <input type="file" multiple class="d-none" id="picture" accept=".png, .jpg, .jpeg, .webp">
                ...
                <div class="col-5">
                    <div class="px-3">
                        ...
                        <div class="form-row" v-for="(item, index) in options" :key="index">
...
export default {
    ...
    async mounted() {
        ...
        this.categoriesAll.splice(0, 0, {
            id: 0,
            name: 'Vui lòng chọn danh muc',
            level: 0
        });
