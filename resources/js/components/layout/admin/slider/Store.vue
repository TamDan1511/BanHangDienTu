            ...
            <div class="mt-4 row">
                <div class="col-5 mx-auto">
                    <form action="Form.vue">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label font-weight-bold">Nội dung:</label>
                            <div class="col-sm-9">
...
export default {
    ...
    methods: {
        form: async function(type) {
            ...
            let slider = await SliderRepository.store(this.slider, type, this);
            this.$loading.hide();
